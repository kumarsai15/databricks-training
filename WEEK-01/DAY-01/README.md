...
🎯 Objective
Build a strong foundation in SQL by learning:
...
No structured files created yet
Practice queries were executed directly using tools like DB Fiddle / SQL environments

🗂️ Dataset Overview
The dataset consists of three tables:
Employee → Employee details (id, name, age, salary, department, hire_date)
...
Understanding grouped query behavior
...
Day 1 establishes a strong foundation in SQL fundamentals, especially aggregation and grouping, which are essential for:
